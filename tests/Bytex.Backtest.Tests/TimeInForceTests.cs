...
public sealed class TimeInForceTests
{
    ...
    [Fact(Skip = "BUG: DAY time in force is not implemented; a DAY order rests like GTC and can fill days later")]
    ...
    [Fact(Skip = "BUG: a limit order with at-the-open time in force is filled at the bar open even when the open is worse than its limit")]
