...
public class StrategyGtdExpiryTests
{
    ...
    [Fact(Skip = "BUG: Strategy.cs:173-176 cancels the GTD timer on any OrderFilled, including a partial fill, so the unfilled remainder of a GTD order is never expired")]
