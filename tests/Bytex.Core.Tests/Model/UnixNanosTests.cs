...
public class UnixNanosTests
{
    ...
    [Theory(Skip = "BUG: UnixNanos.Parse adds digits 8-9 on top of a tick value that DateTimeOffset.Parse already rounded up, so the result is 100 ns too large")]
    ...
    [Fact(Skip = "BUG: UnixNanos.TryParse lets the OverflowException of a date after 2262 escape instead of returning false")]
    ...
    [Fact(Skip = "BUG: UnixNanos.ToString renders negative sub-tick values as '1970-01-01T00:00:00.0000000-01Z'")]
