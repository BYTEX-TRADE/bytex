...
public class CsvTimestampTests
{
    ...
    [Theory(Skip = "BUG: UnixNanos.Parse adds the sub-100ns digits to a DateTimeOffset that .NET has already ROUNDED to 100 ns, so every timestamp whose 8th-9th fractional digits are >= 50 comes out 100 ns too late")]
