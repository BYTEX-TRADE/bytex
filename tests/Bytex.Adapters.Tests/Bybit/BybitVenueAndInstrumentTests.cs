...
public sealed class BybitVenueAndInstrumentTests
{
    ...
    [InlineData("BTCUSDT-26SEP25", BybitProductType.Linear, "BTCUSDT-26SEP25.BYBIT")]
    [InlineData("BTC-26SEP25", BybitProductType.Linear, "BTC-26SEP25.BYBIT")]
    ...
    public async Task A_linear_instrument_still_takes_its_minimum_notional_from_minNotionalValue()
    {
        ...
        Assert.Equal(new Money(5m, Currencies.USDT), provider.Find(InstrumentId.Parse("BTCUSDT-PERP.BYBIT"))!.MinNotional);
    }
}
