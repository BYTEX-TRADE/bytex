...
| Adapters | Binance (spot, USDⓈ-M futures), Bybit (spot, linear perpetuals), KuCoin (spot), Gate (spot, USDT perpetuals, USDT delivery futures); Tardis historical data; adapter SDK for new venues |
...
src/Bytex.Adapters.*         Binance, Bybit, Gate, KuCoin, Tardis
