...
| Adapters | Binance (spot, USDⓈ-M futures, COIN-M futures), Bitget (spot, USDT- and USDC-margined perpetuals), Bybit (spot, linear perpetuals), Gate (spot, USDT perpetuals, USDT delivery futures), Kraken (spot, futures), KuCoin (spot), OKX (spot, perpetual swaps, dated futures); Tardis historical data; adapter SDK for new venues |
