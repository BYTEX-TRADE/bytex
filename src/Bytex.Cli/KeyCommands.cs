...
internal static class KeyCommands
{
    ...
    {
        Option<string> venue = new("--venue") { Description = "BINANCE | BITGET | BYBIT | KUCOIN", Required = true };
        Option<string> envFile = new("--env-file") { Description = "File with KEY=VALUE lines (for example BYBIT_API_KEY=...; Bitget and KuCoin also need a passphrase)", Required = true };
            ...
            try
            {
                ...
                switch (venueName)
                {
                    ...
                    case "KUCOIN":
                        ...
                        break;
                    default:
                        report.Fail("venue", new Failure("venue_unknown", null, null, "expected BINANCE, BITGET, BYBIT or KUCOIN"));
                        break;
                }
            }
