...
internal static class KeyCommands
{
    ...
    {
        Option<string> venue = new("--venue") { Description = "BINANCE | BYBIT | KRAKEN | KUCOIN", Required = true };
            ...
            try
            {
                ...
                switch (venueName)
                {
                    ...
                    case "KRAKEN":
                        ...
                        break;
                    default:
                        report.Fail("venue", new Failure("venue_unknown", null, null, "expected BINANCE, BYBIT, KRAKEN or KUCOIN"));
                        break;
                }
            }
