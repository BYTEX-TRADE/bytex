...
public sealed class Trader : Component
{
    ...
    public Trader(TraderId traderId, IClock clock, ICache cache, IMessageBus bus, IPortfolio portfolio, ExecutionEngine executionEngine, ILoggerFactory loggerFactory, Action<Action>? post = null)
