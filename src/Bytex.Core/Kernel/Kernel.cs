...
public sealed class Kernel : IDisposable
{
    ...
    public Kernel(KernelConfig config, IClock clock, ILoggerFactory? loggerFactory = null, ICacheDatabase? cacheDatabase = null, Action<Action>? post = null)
    {
        ...
        DataEngine = new DataEngine(MessageBus, Cache, config.DataEngine, post);
        ...
        Trader = new Trader(config.TraderId, clock, Cache, MessageBus, Portfolio, ExecutionEngine, LoggerFactory, post, config.Environment);
